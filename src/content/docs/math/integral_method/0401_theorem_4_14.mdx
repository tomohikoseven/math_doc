...
<Statement title="定理4.14" variant="theorem">
...
#align(center)[
  #let domain-axis(name, length, width: 60pt, points: ()) = align(center)[
...
定理4.15（広義積分の積分変数の変換）についてはこちらを参照すること：
[定理4.15 (積分変数の変換と広義積分の収束性および同値性)](/math/integral_method/0402_theorem_4_15/)
