...
## 定理の主張
　[循環しない無限小数はすべて無理数](/real_number/013_irrational_number/)を表わすことを証明するとすぐにわかるらしい．私にはすぐにわからなかった．有理数が稠密であることは[定理1.4](/real_number/012_consistency/)でわかるが，無理数も稠密であることがこの定理の主張である．
...
2. 切断の準備
    ...
    $$ 
    $C$は$C^{\prime}$の補集合とすると，$\langle C,C^{\prime} \rangle$は切断である．（[循環しない無限小数は無理数を表わす](/real_number/013_irrational_number/)を参照．） 
